    ...
    if (file) {
        ...
        reader.onload = function() {
            ...
            img.onload = function() {
                ...
                // Escalar la imagen de salida para mostrarla en la vista previa
                const scaleFactor = 0.1; // Factor de escala para la vista previa (ajústalo según sea necesario)
                const canvasOutput = document.createElement('canvas');
                const ctxOutput = canvasOutput.getContext('2d');
                canvasOutput.width = canvasInput.width * scaleFactor;
                canvasOutput.height = canvasInput.height * scaleFactor;
